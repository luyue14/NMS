...
public class PortConfigs {
	...
	public PortConfigs(){
		...
		portConfigs.add(new PortConfig("openflow:3", "4", "22:c2:c2:c2:c2:c2","110.0.0.2/24", "110.0.0.0/24"));
		...
		portConfigs.add(new PortConfig("openflow:5", "4","22:c7:c7:c7:c7:c7", "172.25.2.110/24", "172.25.2.0/24"));
